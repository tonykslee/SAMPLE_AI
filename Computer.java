 ...
 * @author Tony
 *
 *         This class is the artifical-intelligence that will be playing against
 *         the human. Since it is random who goes first, the AI is not always
 *         going to be alpha/max or the beta/min player and same goes with the
 *         human.
 */
public class Computer {
	...
	/**
	 * The alpha-beta-pruning algorithm that the AI will follow to play the best
	 * move possible against the human. The strength of the AI depends on the depth
	 * which is the number of moves that the computer can foresee.
	 * 
	 * @param depth
	 *            number of moves that the computer can foresee.
	 * @param gameBoard
	 *            the future gameboard states.
	 * @param alphaPlayer
	 *            whether the AI is an alpha player.
	 * @param alpha
	 *            the heuristic score of alpha player.
	 * @param beta
	 *            the heuristic score of beta player.
	...
	/**
	 * The min-max algorithm that the AI will follow to find the best possible move
	 * against the human. The strength of the AI move will depend on the depth.
	 * 
	 * @param depth
	 *            number of moves that the computer can foresee.
	 * @param gameBoard
	 *            future states of the gameboard.
	 * @param alphaPlayer
	 *            whether the AI is alpha or beta player.
	 * @return returns the coordinates of intelligent move.
	 */
